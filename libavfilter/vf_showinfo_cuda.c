...
const FFFilter ff_vf_showinfo_cuda = {
    .p.name        = "showinfo_cuda",
    .p.description = NULL_IF_CONFIG_SMALL("Show textual information for each CUDA video frame."),
    .p.priv_class  = &showinfo_cuda_class,
